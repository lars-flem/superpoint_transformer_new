...
from src.datasets.norway_trondheim2022_config import TILES, ID2TRAINID, CLASS_NAMES, CLASS_COLORS, NOR_NUM_CLASSES
from src.utils.color import to_float_rgb

DIR = os.path.dirname(os.path.realpath(__file__))
log = logging.getLogger(__name__)

__all__ = ['NorwayTrondheimALS', 'MiniNorwayTrondheimALS']
...
class NorwayTrondheimALS(BaseDataset):
...
class MiniNorwayTrondheimALS(NorwayTrondheimALS):
    _NUM_MINI = 2
